...
#include <cstrike>
#include <clientprefs>
#include <kento_rankme_teamgen/rankme>
...
public Plugin myinfo =  {
    name = "RankMe+TeamGen", 
    author = "tontsakaze, lok1, Scooby, Kento, pracc, Kxnrl, CrazyHackGUT", 
    description = "Improved RankMe for CSGO with team generator", 
    version = PLUGIN_VERSION, 
    url = "https://github.com/tontsakaze/RankMe-TeamGenerator"
};
...
public void OnPluginStart() {
    ...
    // SERVER COMMANDS
    RegServerCmd("mp_genteams", CMD_MpGenTeams, "RankMe: Generates random teams based on scores");
    ...
    RegAdminCmd("sm_genteams", CMD_SmGenTeams, ADMFLAG_ROOT, "RankMe: Generates random teams based on scores");
